...
void solvePuzzle(){
  ...
  current?.giveChips();
  int total = 1;
  for(MapEntry entry in outputs.entries) if(checkOutputs.contains(entry.key)) total *= (entry.value as Output).chips[0];
  print('The multiplied total for values of chips in outputs $checkOutputs is $total');
}
